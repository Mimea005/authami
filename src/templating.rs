...
impl Handler for TemplateFileServer {
    ...
    async fn handle<'r>(&self, req: &'r Request<'_>, data: Data<'r>) -> Outcome<'r> {
        ...
        if segments.is_dir() && self.use_index_files {
            println!("Using index files");
            segments.push("index");
        }
        ...
        println!("\t>> TemplateFileServer is not yet implemented");
